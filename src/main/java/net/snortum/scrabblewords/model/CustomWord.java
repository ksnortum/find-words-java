...
public class CustomWord implements Comparable<CustomWord> {
	...
	/**
	 * Create a custom word and definition, optionally adding 50 points for a bingo
	 * 
	 * @param word       the word formed by the Scrabble tiles for display
	 * @param valueWord  the word that carries the value of the CustomWord, that
	 ...
	 */
	public CustomWord(String word, String valueWord, boolean isBingo, String definition) {
		if (word == null) {
	 ...
	 */
	public CustomWord(String word, String valueWord, boolean isBingo) {
	 ...
	 */
	@Override
	public int compareTo(CustomWord that) {
